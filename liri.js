...
var spotifyThisSong = function (trackQuery) {
	...
	// Load exports from keys.js file which has Twitter auth keys
	var keys = require("./keys.js");
	//var spotifyCredentials = keys.spotifyKeys;
...
var movieThis = function (movieQuery) {
	...
	// HTTP GET request
	request("http://www.omdbapi.com/?apikey=" + apikey + "&t=" + movieQuery + "&y=&plot=short&r=json", function (error, response, body) {
